...
export class AddSoulAndHeartbeat1743400000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE agents ADD COLUMN IF NOT EXISTS personality TEXT NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE agents DROP COLUMN IF EXISTS personality`);
  }
}
