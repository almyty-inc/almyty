...
/**
 * Model catalog: the cards the router reads, the router itself, and the
 * automatic price feed. The chat runner (llm-providers) consumes the
 * router; the validation run here consumes the chat runner, hence the
...
@Module({
  ...
  providers: [PriceFeedService, PriceFeedProcessor, ModelRouterService, ModelCatalogService],
