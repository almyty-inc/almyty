...
export class MonitoringService extends EventEmitter implements OnModuleInit, OnModuleDestroy {
  ...
  async getPrometheusMetrics(): Promise<string> {
    ...
    const prometheusMetrics = [
      `# HELP apifai_uptime_seconds Total uptime in seconds`,
      `# TYPE apifai_uptime_seconds counter`,
      `apifai_uptime_seconds ${metrics.system.uptime}`,
      ``,
      `# HELP apifai_memory_usage_bytes Memory usage in bytes`,
      `# TYPE apifai_memory_usage_bytes gauge`,
      `apifai_memory_usage_bytes{type="heap"} ${metrics.system.memoryUsage.heapUsed}`,
      `apifai_memory_usage_bytes{type="heap_total"} ${metrics.system.memoryUsage.heapTotal}`,
      ``,
      `# HELP apifai_tools_total Total number of tools`,
      `# TYPE apifai_tools_total gauge`,
      `apifai_tools_total ${metrics.application.tools.total}`,
      ``,
      `# HELP apifai_tools_active Active tools`,
      `# TYPE apifai_tools_active gauge`,
      `apifai_tools_active ${metrics.application.tools.active}`,
      ``,
      `# HELP apifai_requests_total Total requests processed`,
      `# TYPE apifai_requests_total counter`,
      `apifai_requests_total{status="success"} ${metrics.application.requests.successful}`,
      `apifai_requests_total{status="error"} ${metrics.application.requests.failed}`,
      ``,
      `# HELP apifai_response_time_ms Average response time in milliseconds`,
      `# TYPE apifai_response_time_ms gauge`,
      `apifai_response_time_ms ${metrics.performance.averageResponseTime}`,
      ``,
      `# HELP apifai_mcp_sessions Active MCP sessions`,
      `# TYPE apifai_mcp_sessions gauge`,
      `apifai_mcp_sessions ${metrics.protocols.mcp.sessions}`,
      ``,
      `# HELP apifai_a2a_agents Active A2A agents`,
      `# TYPE apifai_a2a_agents gauge`,
      `apifai_a2a_agents ${metrics.protocols.a2a.activeAgents}`,
    ];
