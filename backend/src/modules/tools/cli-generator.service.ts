...
export class CliGeneratorService {
  ...
  private renderBashScript(tool: Tool): string {
    ...
    lines.push(`# Generated by apifai`);
    lines.push('');
    ...
    lines.push('BASE_URL="${APIFAI_BASE_URL:-http://localhost:4000}"');
    lines.push('TOKEN="${APIFAI_TOKEN:-}"');
    lines.push('');
    ...
    // Execute via apifai UTCP endpoint
    lines.push('# Execute tool via apifai');
  ...
  private renderNodeScript(tool: Tool): string {
    ...
    lines.push('// Generated by apifai');
    lines.push('');
    lines.push("const BASE_URL = process.env.APIFAI_BASE_URL || 'http://localhost:4000';");
    lines.push("const TOKEN = process.env.APIFAI_TOKEN || '';");
    lines.push('');
