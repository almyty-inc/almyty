...
export class LlmProvidersController {
  ...
  private getProviderDisplayName(type: LlmProviderType): string {
    const names = {
      ...
      [LlmProviderType.CUSTOM]: 'Custom Provider',
    };
  ...
  private getProviderDescription(type: LlmProviderType): string {
    const descriptions = {
      [LlmProviderType.OPENAI]: 'OpenAI GPT models including GPT-4 and GPT-3.5',
      [LlmProviderType.ANTHROPIC]: 'Anthropic Claude models with advanced reasoning capabilities',
      [LlmProviderType.GOOGLE]: 'Google Gemini models with multimodal capabilities',
      [LlmProviderType.COHERE]: 'Cohere language models for various NLP tasks',
      [LlmProviderType.HUGGINGFACE]: 'Hugging Face hosted models and inference API',
      [LlmProviderType.AZURE_OPENAI]: 'OpenAI models hosted on Microsoft Azure',
      [LlmProviderType.AWS_BEDROCK]: 'Foundation models available through AWS Bedrock',
      [LlmProviderType.CUSTOM]: 'Custom API endpoint with configurable request format',
    };
  ...
  private getProviderFeatures(type: LlmProviderType): string[] {
    const features = {
      [LlmProviderType.OPENAI]: ['Function Calling', 'Streaming', 'Vision', 'Tool Use'],
      [LlmProviderType.ANTHROPIC]: ['Tool Use', 'Streaming', 'Vision', 'Large Context'],
      [LlmProviderType.GOOGLE]: ['Streaming', 'Vision', 'Large Context'],
      [LlmProviderType.COHERE]: ['Streaming', 'Text Generation'],
      [LlmProviderType.HUGGINGFACE]: ['Multiple Models', 'Open Source'],
      [LlmProviderType.AZURE_OPENAI]: ['Enterprise Security', 'Function Calling', 'Vision'],
      [LlmProviderType.AWS_BEDROCK]: ['Multiple Providers', 'Enterprise Security'],
      [LlmProviderType.CUSTOM]: ['Flexible Configuration', 'Any API'],
    };
