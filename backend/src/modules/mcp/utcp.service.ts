...
export class UtcpService {
  ...
  async generateManual(organizationId: string): Promise<UtcpManual> {
    ...
    const manual: UtcpManual = {
      ...
      info: {
        ...
        description: `UTCP manual for ${organization.name}'s API tools, automatically generated by apifai`,
        version: '1.0.0',
        contact: {
          name: 'apifai',
          url: 'https://apifai.dev',
        },
        license: {
          name: 'Generated by apifai',
          url: 'https://apifai.dev/license',
        },
      },
      tools: utcpTools,
      callTemplates,
  ...
  private async generateCallTemplate(tool: Tool): Promise<UtcpCallTemplate | null> {
    ...
    return {
      ...
      description: `Direct API call template for ${tool.name} - bypasses apifai proxy`,
      protocol: 'http',
      endpoint: {
        ...
        headers: {
          ...
          'User-Agent': 'apifai-utcp-client/1.0.0',
          ...api.headers,
        },
