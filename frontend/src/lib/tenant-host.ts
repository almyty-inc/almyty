 ...
 * did not agree to anything from us; nothing about them is sent to our
 * PostHog or Sentry from that page.
 */
export function telemetryAllowedOn(location: Location = window.location): boolean {
