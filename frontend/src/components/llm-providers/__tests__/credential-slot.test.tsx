...
function EditHarness({ provider, onUpdate }: { provider: any; onUpdate: (payload: any) => void }) {
  ...
  return <ProviderSettingsForm editForm={form} providerToEdit={provider} updateProviderMutation={mutation} onCancel={() => {}} />
}
...
describe('ProviderSettingsForm credential slots', () => {
