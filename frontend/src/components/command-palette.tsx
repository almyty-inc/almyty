...
export function CommandPalette() {
  ...
  const navigationEntries: Entry[] = [
    ...
    { id: 'nav-connections', label: 'Connections', icon: Key, action: () => go('/connections'), keywords: ['credentials', 'vault', 'secrets', 'keys', 'accounts', 'oauth'] },
    { id: 'nav-connections-advanced', label: 'Connections: advanced', icon: Key, action: () => go('/connections/advanced'), keywords: ['grants', 'access', 'policies', 'rules', 'custom connector', 'personal keys'] },
  ...
  const actionEntries: Entry[] = [
    ...
    { id: 'act-new-connection-policy', label: 'Add a connection rule', hint: 'Govern who may use which connection', icon: Plus, action: () => go('/connections/policies/new') },
