...
export function CommandPalette() {
  ...
  const actionEntries: Entry[] = [
    ...
    { id: 'act-new-api', label: 'Import API', hint: 'OpenAPI, GraphQL, SOAP, Protobuf, SDK', icon: Plus, action: () => go('/apis/new') },
    ...
    { id: 'act-new-access-key', label: 'Generate Access Key', hint: 'A key for a gateway or an agent', icon: Plus, action: () => go('/credentials/access-keys/new') },
  ]
