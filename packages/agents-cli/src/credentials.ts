 ...
 *
 * Identical to packages/auth-cli/src/credentials.ts (intentional copy
 * to keep each CLI package self-contained — these few helpers don't
 * justify a workspace dependency).
 */
