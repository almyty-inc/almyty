...
The analytics dashboard gives you real-time visibility into usage across all protocols, tools, agents, and LLM providers. Seven tabs cover different aspects of your organization's activity. The numbers are live — gateway traffic, tool executions, and agent runs feed the tiles and charts as they happen, with a 30-second refresh on the Overview tab.
