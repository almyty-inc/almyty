...
After importing a schema, navigate to **Tools** to see the auto-generated tools. Each operation from your API becomes a tool with typed parameters, descriptions, and validation.
...
After creating a gateway, assign tools to it from the **Tool Scoping** tab:
...
Access keys for CLI and programmatic access are managed in the **Access Keys** tab.
