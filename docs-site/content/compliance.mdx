...
- **Your side**: a records-of-processing entry for each agent, a lawful basis for the data it handles, data-processing agreements with your model providers (you are sending them conversation content under your own API keys), and retention schedules. Self-hosting in your own EU infrastructure keeps residency entirely in your hands.
