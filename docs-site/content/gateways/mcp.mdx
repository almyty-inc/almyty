...
2. Choose **Tools**, then **MCP** as the protocol
3. Enter a name, an endpoint path (used in the URL), and an optional description
4. Choose visibility and click **Create gateway**

On the gateway detail page, open **Tool scoping** to assign the tools this gateway should expose, then use the **Authentication** section to add an auth method before going live. The **Integrations** tab provides the client endpoints.
