...
```json
{
  "mcpServers": {
    "billing": {
      "url": "https://api.almyty.com/acme/billing",
      "headers": {
...
```
https://api.almyty.com/acme/billing/.well-known/oauth-authorization-server
https://api.almyty.com/acme/billing/.well-known/oauth-protected-resource
```
