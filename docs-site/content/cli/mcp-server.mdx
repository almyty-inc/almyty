...
![@almyty/mcp-server CLI help](/screenshots/cli/mcp-server-help.png)
...
Your gateway ID is `org/slug`, shown on the gateway detail page. For example, if your org is "acme" and your gateway slug is "billing":
