...
![Create Manual Tool execution method selector, including Model Prompt](/screenshots/tools-create-dialog.png)

## Create one in the UI

1. Open **Tools**, click **Create Tool**, select **LLM**.
2. Give it a **name** and **description**.
3. Choose an **LLM provider** and **model** from your configured providers (set these up under **Models > Inference providers** first).
