...
3. Choose a model with the shared model picker. Set up its inference provider under **Models → Inference providers** first if needed.
...
Configure providers in **Models > Inference providers** before creating LLM tools.
