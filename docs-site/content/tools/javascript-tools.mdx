...
1. Open **Tools → Create tool** (`/tools/new`) and select **Custom JavaScript**.
2. Give it a **name** and **description**.
3. Define **input parameters** in the JSON Schema builder. These arrive as `parameters` in your code.
4. Write your code. `parameters`, `credentials`, `require`, and optionally `tools` are available in the closure.
5. Choose the tool's visibility and click **Create tool**.
6. On the tool's detail page, use **Test tool** with sample inputs to check the output.
