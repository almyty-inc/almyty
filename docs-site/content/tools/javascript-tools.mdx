...
Node.js worker sandbox. They offer maximum flexibility for data transformation,
computation, and integration with services that lack a ready-made HTTP or
GraphQL wrapper -- including any npm package you want to pull in.
