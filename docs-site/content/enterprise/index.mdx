...
almyty is open core. Everything you've read about so far — agents, tools, gateways, memory, runners, approvals, spend budgets, the basic audit log — is Apache-2.0 and free forever. A small set of enterprise features lives under `backend/ee/` in the same repository under a commercial license (see [LICENSING.md](https://github.com/almyty/almyty/blob/main/LICENSING.md)).
