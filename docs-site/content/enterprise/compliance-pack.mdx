...
Without the `compliance_pack` entitlement, **Settings → Compliance** shows the locked view below, not an enabled organization-wide policy.

![Compliance settings locked on a Pro demo organization](/screenshots/settings-compliance-locked.png)
