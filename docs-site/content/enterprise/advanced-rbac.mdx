...
Without the `advanced_rbac` entitlement, **Settings → Roles** shows this locked view. The core member and team controls remain available separately.

![Advanced RBAC settings locked on a Pro demo organization](/screenshots/settings-rbac-locked.png)
