...
Without the `sso` entitlement, **Settings → SSO** shows the locked view below. This Pro demo organization has no SSO configuration controls available.

![SSO settings locked on a Pro demo organization](/screenshots/settings-sso-locked.png)
