...
With the entitlement enabled, **Settings → SSO** provides identity-provider configuration and SCIM provisioning controls. The demo below has access to these controls, but SSO remains off until an administrator configures and enables it.
